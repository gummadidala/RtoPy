...
logging.getLogger('configs').setLevel(logging.ERROR)  # Only show ERROR and above for configs
warnings.filterwarnings('ignore', message='Could not import module')

sys.path.append(str(Path(__file__).parent.parent))
from SigOps.configs import get_det_config_, get_cam_config
